      ...
      <form onSubmit={handleSubmit} className="space-y-2">
        ...
        <div className="flex gap-2 items-center rounded-lg p-1">
          ...
          <div className="flex-1 relative">
            <div className="flex items-center gap-2 border rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-60 focus-within:ring-1 focus-within:ring-gray-500 focus-within:border-gray-500 transition-all duration-200 text-white">
              {selectedEnvironment && (
